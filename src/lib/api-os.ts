...
export interface DocumentoFiscal {
  ...
  DCFS_SERIE?: string;
  DCFS_SERIE_NOTA?: string;
  DCFS_MODELO_NOTA?: string;
  DCFS_DATA_EMISSAO?: string;
  DCFS_DATA_NOTA?: string;
  DCFS_DATA_SAIDA?: string;
  DCFS_DATA_CANCELAMENTO?: string;
  DCFS_NOME?: string;
  DCFS_RAZAO_SOCIAL?: string;
  DCFS_CPFCNPJ?: string;
  DCFS_VALOR_TOTAL?: string | number;
  DCFS_VLR_TOTAL?: string | number;
  DCFS_SITUACAO?: string;
  DCFS_STATUS?: string;
  DCFS_TIPO?: string;
  DCFS_CHAVE?: string;
  DCFS_CHAVE_ACESSO_NFE?: string;
  DCFS_DIGITO_CHAVE?: string;
